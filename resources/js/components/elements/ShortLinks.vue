	            ...
	            <div class="col-12 col-sm-6 col-md-3 col-lg-3">
	                <div class="dc-widgetbylocation">
	                    ...
	                    <ul class="dc-fwidgetcontent">
	                        ...
	                        <li><a href="javascript:void(0);">Our Blood Donors</a></li>
	                        <li><a href="javascript:void(0);">Our Events</a></li>
	                        <li><a href="javascript:void(0);">Report Us</a></li>
	                        <li><a href="javascript:void(0);">Our Blog / Health Tips</a></li>
	                        <li class="dc-viewmore"><a href="javascript:void(0);">Make a donation </a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
